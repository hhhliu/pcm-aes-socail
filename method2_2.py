# -*- coding: utf-8 -*-
"""
Created on Sat Jan 27 19:24:23 2018
...
if __name__ == '__main__':
    ...
    model_tag=Dense(256, activation='relu',name='tag3')(model_tag)
    model_user=Dense(1000, activation='relu',name='user1')(x)
    model_user=Dense(256, activation='relu',name='user3')(model_user)   
    model_group=Dense(1000, activation='relu',name='group1')(x) 
    model_group=Dense(256, activation='relu',name='group3')(model_group)      
    merge=concatenate([model_tag,model_user,model_group])
    output = Dense(256, activation='relu')(merge)
    model1=Model(outputs=output,inputs=input_tensor)
    model1.load_weights('/home/liuhuihui/ME/pagerank/newmodel/method2_1_change.h5',by_name=True)
    ...
    with h5py.File(path_train, 'r') as train_file:
        ...
        Checkpoint = ModelCheckpoint(filepath='/home/liuhuihui/ME/pagerank/newmodel/method2_2_change.h5', monitor='val_loss', verbose=1,
